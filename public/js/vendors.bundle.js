    ...
    (function() {
      ...
      for (
        v = {
          ...
          U = 0,
          Y = (K = ["ajax", "document", "eventLag", "elements"]).length;
        U < Y;
        U++
      )
        !0 === P[(M = K[U])] && (P[M] = v[M]);
      ...
      (Q = Error),
              ...
              : ((r = arguments),
                ...
                setTimeout(function() {
                  ...
                  if (
                    ...
                    for (
                      b.restart(), o = [], t = 0, e = (i = b.sources).length;
                      t < e;
                      t++
                    ) {
        ...
        (f = function(t) {
          var e,
            ...
            r = this;
          for (
            n = this.progress = 0, i = (o = ["error", "open"]).length;
            n < i;
            n++
          )
            (e = o[n]),
        ...
        (D = function() {
          ...
          for (
            b.sources = R = [],
              e = 0,
              i = (r = ["ajax", "elements", "document", "eventLag"]).length;
            e < i;
            e++
          )
            !1 !== P[(t = r[e])] && R.push(new h[t](P[t]));
          for (
            n = 0, o = (a = null != (s = P.extraSources) ? s : []).length;
            n < o;
            n++
          )
        ...
        (b.go = function() {
          ...
          return (
            ...
            (d = O(function(t, e) {
              ...
              for (
                100 - _.progress, i = h = 0, o = !0, a = f = 0, d = R.length;
                f < d;
                a = ++f
              )
                for (
                  M = R[a],
                    u = null != L[a] ? L[a] : (L[a] = []),
                    l = p = 0,
                    g = (s = null != (m = M.elements) ? m : [M]).length;
                  p < g;
                  l = ++p
                )
                  (r = s[l]),
      ...
      (function(t, e) {
            ...
            (g = at.select = function(t, e, n, i) {
              ...
              if (((n = n || []), 1 === u.length)) {
                if (
                  ...
                  if (
                    !(e = (_.find.ID(s.matches[0].replace(it, h), e) || [])[0])
                  )
                    return n;
                  c && (e = e.parentNode),
                ...
                for (
                  o = $.needsContext.test(t) ? 0 : r.length;
          ...
          if (i[1]) {
            if (
              ...
              T.merge(
                ...
                T.parseHTML(
                  i[1],
                  e && e.nodeType ? e.ownerDocument || e : E,
                  !0
                )
              ),
          ...
          special: {
            ...
            click: {
              ...
              trigger: function(t) {
                var e = this || t;
                return (
                  ht.test(e.type) && e.click && k(e, "input") && Dt(e, "click"),
                  !0
                );
              },
              _default: function(t) {
        ...
        function Mt(n, i, o, r) {
          ...
          if (
            ...
            if (a)
              for (
                c = s[s.length - 1].ownerDocument, T.map(s, jt), u = 0;
                u < a;
                u++
              )
                (l = s[u]),
        ...
        T.extend({
          ...
          cleanData: function(t) {
            for (
              var e, n, i, o = T.event.special, r = 0;
              void 0 !== (n = t[r]);
              r++
            )
              if (K(n)) {
          ...
          T.each(
            ...
            function(t, s) {
              T.fn[t] = function(t) {
                for (
                  var e, n = [], i = T(t), o = i.length - 1, r = 0;
                  r <= o;
                  r++
                )
            ...
            stop: function(o, t, r) {
              ...
              return (
                ...
                this.each(function() {
                  ...
                  else for (e in i) i[e] && i[e].stop && me.test(e) && s(i[e]);
                  for (e = n.length; e--; )
                    n[e].elem !== this ||
                      (null != o && n[e].queue !== o) ||
        ...
        T.extend(T.event, {
          trigger: function(t, e, n, i) {
            ...
            if (
              ...
              if (!i && !u.noBubble && !g(n)) {
                for (
                  a = u.delegateType || p, Ne.test(a + p) || (r = r.parentNode);
                  r;
                  r = r.parentNode
                )
                  f.push(r), (s = r);
              ...
              m.hasContent
                ...
                : ((r = m.url.slice(h.length)),
                  m.data &&
                    ...
                    ((h += (Le.test(h) ? "&" : "?") + m.data), delete m.data),
                  !1 === m.cache &&
                    ((h = h.replace(Be, "$1")),
                    (r = (Le.test(h) ? "&" : "?") + "_=" + Oe++ + r)),
                  (m.url = h + r)),
      ...
      (function(t) {
        ...
        function o(t, e) {
          ...
          return "area" === r
            ? ((i = (n = t.parentNode).name),
              !(!t.href || !i || "map" !== n.nodeName.toLowerCase()) &&
                !!(o = y("img[usemap='#" + i + "']")[0]) &&
                s(o))
        ...
        (y.cleanData =
          ...
          (y.widget.extend = function(t) {
            for (
              var e, n, i = l.call(arguments, 1), o = 0, r = i.length;
              o < r;
              o++
            )
              for (e in i[o])
                      ...
                      return "instance" === n
                        ...
                        ? y.isFunction(e[n]) && "_" !== n.charAt(0)
                          ? (t = e[n].apply(e, i)) !== e && void 0 !== t
                            ? ((o = t && t.jquery ? o.pushStack(t.get()) : t),
                              !1)
                            : void 0
                          : y.error(
                              "no such method '" +
            ...
            option: function(t, e) {
              ...
              if ("string" == typeof t)
                if (((r = {}), (t = (n = t.split(".")).shift()), n.length)) {
                  for (
                    i = r[t] = y.widget.extend({}, this.options[t]), o = 0;
                    o < n.length - 1;
                    o++
                  )
                    (i[n[o]] = i[n[o]] || {}), (i = i[n[o]]);
          ...
          _mouseInit: function() {
            ...
            this.element
              ...
              .bind("click." + this.widgetName, function(t) {
                if (
                  !0 === y.data(t.target, e.widgetName + ".preventClickEvent")
                )
                  return (
          ...
          _mouseCapture: function(t) {
            ...
            return (
              ...
              !(
                ...
                !!this.handle &&
                  (this._blockFrames(
                    !0 === e.iframeFix ? "iframe" : e.iframeFix
                  ),
                  !0))
            );
          },
            ...
            _getItemsAsjQuery: function(t) {
              ...
              if (a && t)
                for (e = a.length - 1; 0 <= e; e--)
                  for (
                    n = (i = y(a[e], this.document[0])).length - 1;
                    0 <= n;
                    n--
                  )
            ...
            _refreshItems: function(t) {
              ...
              if (h && this.ready)
                for (e = h.length - 1; 0 <= e; e--)
                  for (
                    n = (i = y(h[e], this.document[0])).length - 1;
                    0 <= n;
                    n--
                  )
                    (o = y.data(i[n], this.widgetFullName)) &&
        ...
        function M(t) {
          ...
          else for (e in i) "string" == typeof i[e] && (o[e] = i[e]);
          return o;
        }
      ...
      (function(t, e) {
            ...
            return (
              ...
              (c._dataApiKeydownHandler = function(t) {
                if (
                  ...
                  (t.preventDefault(),
                  t.stopPropagation(),
                  !this.disabled && !d(this).hasClass(Nt))
                ) {
        ...
        d(window).on(fn.LOAD_DATA_API, function() {
          for (
            var t = [].slice.call(document.querySelectorAll(gn)), e = t.length;
            e--;
        ...
        Object.keys ||
          (Object.keys =
            ...
            function(t) {
              ...
              if (r) for (n = 0; n < a; n++) o.call(t, s[n]) && i.push(s[n]);
              return i;
            }));
        var f = {};
        f.VERSION = "5.0.0";
                  ...
                  var v,
                    b = D(c)
                      ...
                      .css({
                        ...
                        top: 0,
                        display:
                          k.alwaysVisible && k.railVisible ? "block" : "none",
